#!/bin/bash
# Regenerates .github/media/homelab-header.png (the README header card).
#
# Adapted from https://github.com/resend/n8n-nodes-resend/tree/main/.github/media
#
# Prerequisites:
...
TITLE="${TITLE:-homelab}"
SUBTITLE="${SUBTITLE:-A k3s cluster defined entirely in Git, synced by Argo CD}"
ICON="${ICON:-$HERE/homelab-icon.svg}"
...
OUT="${OUT:-$HERE/homelab-header.png}"
SEED="${SEED:-42}"
